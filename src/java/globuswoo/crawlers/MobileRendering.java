...
//        MobileRendering objMobileRendering = new MobileRendering();
//        objMobileRendering.saveImage("tcs.com");
//    }
...
//*******************************CODE FOR IPHONE IMAGE**************************
        try {
            ...
            String destName = "C:\\inetpub\\globustracker\\Globuswooclonecrawler\\temp\\" + fileName.substring(fileName.lastIndexOf("/"));
...
//*******************************CODE FOR IPAD IMAGE**************************
        try {
            ...
            String destName1 =  "C:\\inetpub\\globustracker\\Globuswooclonecrawler\\temp\\" + fileName1.substring(fileName1.lastIndexOf("/"));
...
//*******************************CODE FOR DASHBOARD IMAGE***********************
        try {
            ...
            String destName2 = "C:\\inetpub\\globustracker\\Globuswooclonecrawler\\temp\\" + fileName2.substring(fileName2.lastIndexOf("/"));
